...
//////////////////turret bombs hitting ships and players///////////////////////////////////////////////
	...
	addsuperboss(size,turretnum,hp,shield,turrethp,turretshield,parentid){
	 ...
	 8,4,10,6,1,10,0.3,0.3,10,4,1,10,64,8,10,50,"white","ID not implemented")];
		...
		this.levelup(botindex,8);//levelup(botindex,levels){//adds "levels" to make bots tougher, is a system function for some reason.
