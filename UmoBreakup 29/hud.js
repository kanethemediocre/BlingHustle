...
///////////////Rest of HUD/////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	if (allblasters[0].phas){context.fillStyle = "white";}else{context.fillStyle = "grey";}
	context.fillText("0",8,110);
	if (allblasters[1].phas){context.fillStyle = "white";}else{context.fillStyle = "grey";}
	context.fillText("1",16,110);
	if (allblasters[2].phas){context.fillStyle = "white";}else{context.fillStyle = "grey";}
	context.fillText("2",24,110);
	if (allblasters[3].phas){context.fillStyle = "white";}else{context.fillStyle = "grey";}
	context.fillText("3",32,110);
	if (allblasters[4].phas){context.fillStyle = "white";}else{context.fillStyle = "grey";}
	context.fillText("4",40,110);
	if (allblasters[5].phas){context.fillStyle = "white";}else{context.fillStyle = "grey";}
	context.fillText("5",48,110);
	if (allblasters[6].phas){context.fillStyle = "white";}else{context.fillStyle = "grey";}
	context.fillText("6",56,110);
	if (allblasters[7].phas){context.fillStyle = "white";}else{context.fillStyle = "grey";}
	context.fillText("7",64,110);
	if (allblasters[8].phas){context.fillStyle = "white";}else{context.fillStyle = "grey";}
	context.fillText("8",72,110);
	if (allblasters[9].phas){context.fillStyle = "white";}else{context.fillStyle = "grey";}
	...
	allblasters[wep].drawstats(8,250);
